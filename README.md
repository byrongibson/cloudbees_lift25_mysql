...
([MySQL][22]), a source repository (populated, ready to go), and a [Jenkins build service][23] 
...
[default Lift 2.4 ClickStart][9] including a [MySQL][20] instance.  Please see the 
